 ...
 */
class HourlyOHLCVEndpoint extends BaseEndpoint {
  /**
   * Get hourly OHLCV data for tokens with automatic date chunking and pagination.
   * 
   ...
   * @returns {Promise<Object>} - Hourly OHLCV data with all pages and date ranges combined
   * 
   * Note:
   ...
   */
  async get(options = {}) {
    return this._paginatedRequest('get', 'hourly-ohlcv', options, 29);
  }
}

module.exports = HourlyOHLCVEndpoint;
